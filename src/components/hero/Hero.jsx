  ...
  return (
    <div className="hero">
      <div className="wrapper">
        ...
        >
          ...
          <motion.p variants={textVariants}>
            ...
            for organizational goals.My role focuses on leading high-performing
            teams, implementing innovative solutions,and driving technology
            strategies to support efficient, scalable operations.
          </motion.p>
      ...
      <motion.div
        ...
        animate="animate"
      >
        We can solve 99.99% percent of solutions
      </motion.div>
